...
## Lessons learned
One of the limiting factors is when the rest of the organisation still behaves the traditional way. This only leads to incremental improvements due the conflicts of culture, goal. #lessonlearned
